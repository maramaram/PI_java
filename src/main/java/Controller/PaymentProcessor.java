...
public class PaymentProcessor {
    ...
    private static final String STRIPE_API_KEY = ""; // your API secret key

    public static boolean processPayment(String name, String email,  String cardNumber, int cardExpMonth, int cardExpYear, String cardCvc) throws StripeException {
