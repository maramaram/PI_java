...
public class Post {
    ...
    public Post(int id, String title, String contenu, Date date, String image, int views,  int user_id , List<Comment> comments) {
        this.id = id;
        this.title = title;
    ...
    public Post(String title, String contenu, Date date, String image, int views,int user_id, List<Comment> comments) {
